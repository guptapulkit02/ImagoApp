...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        //and attach the UIWindow `window` to
        //the provided UIWindowScene `scene`.
        
        // If using a storyboard, the `window`
        //property will automatically be initialized
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        ...
        // This occurs shortly after the
        // scene enters the background, or
        //when its session is discarded.
        
        // Release any resources associated
        //with this scene that can be re-created
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        //tasks that were paused (or not yet started)
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        //release shared resources, and store enough
